...
import { IonRange, AlertController } from '@ionic/angular';
...
export class SalaPage implements OnInit {
  ...
  async eliminar(ind){
      ...
      const alert = await this.alertController.create({
       header:"¿Deseas eliminar este dispositivo?",
        subHeader: "Una vez eliminado, no se podrá recuperar.",
        buttons:[
          {
            text: 'No',
            role: 'cancel',
          ...
          },
          {
            text: 'Si',
            handler: () => {
              console.log('Confirm '+this.luces[ind].nombre+ " " + this.luces[ind]._id);
            }
          }
        ]
      });
